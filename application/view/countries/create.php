    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Create Country</h2>
                    <ol class="breadcrumb">
                        ...
                        <div class="card-body">
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <div>
                                    ...
                                    <p class="text-muted card-sub-title">Enter the required fields to create the new country.</p>
                                </div>
                                <form id="form-create-country">
                                    <div class="form-group">
                                        <div class="row row-sm">
                                            <div class="col-sm-6">
                                                <label class="">Name: <span class="tx-danger">*</span></label>
                                                <input name="country-name" class="form-control" required="" type="text" placeholder="Type here...">
                                            </div>
                                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div id="country-published" class="main-toggle main-toggle-success on check-toggle" data-input="published">
                                                    <span></span>
                                                </div>
                                    ...
                                    <div class="d-flex flex-row justify-content-end">
                                        <span id="create-country" class="btn ripple btn-main-primary btn-lg">Create</span>
                                    </div>
                                </form>
                            </div>
                        </div>
