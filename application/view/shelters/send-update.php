    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Send Updates for: <?php echo (isset($shelter->shelter_name)) ? $shelter->shelter_name : '' ; ?> </h2>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Send Updates</li>
                    </ol>
                </div>
            </div>
            <!-- End Page Header -->
            ...
            <!--Row-->
            <form id="form-send-shelter-update" class="">
                <div class="row row-sm">
                    <?php if(!empty($shelter) AND $shelter != NULL): ?>
                        <div class="col-lg-12 col-md-12">
                            <div class="card custom-card">
                                <div class="card-body" style="border: 4px solid lightskyblue;">
                                    <div class="col-md-12 col-lg-12 col-xl-12">
                                        <div>
                                            <h6 class="main-content-label mb-1">Instructions</h6>
                                            <p class="text-muted card-sub-title mb-0 mt-2">1. Edit the current information and click "Send update". </p>
                                            <p class="text-muted card-sub-title mb-0">2. Wait for your update to be approved.  </p>
                                            <p class="text-muted card-sub-title mb-0">3. View the status of your update in <a href="<?php echo URL; ?>shelters/updates">"Shelter updates"</a>.   </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="col-md-12 col-lg-12 col-xl-12">
                                        <div>
                                            ...
                                            <p class="text-muted card-sub-title">Enter the required fields to update the shelter.</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input name="shelter-name" class="form-control" required="" type="text" value="<?php echo $shelter->shelter_name; ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="font-weight-semibold">Contact Name:</label>
                                                    <input name="contact-name" class="form-control" value="<?php echo $shelter->contact_name; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input name="shelter-data" class="form-control" type="text" value="<?php echo $shelter->shelter_data; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <div class="jumbotron pt-3 pb-3 mt-3" id="financial-section" style="<?php echo ($shelter->financials == 1) ? '':'display: none;'; ?>">
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        <span id="send-shelter-update" data-shelter="<?php echo $shelter->id; ?>" class="btn ripple btn-main-primary btn-lg mb-3 mt-5">Send update</span>
                                    </div>
                                </div>
                            </div>
                        </div>
