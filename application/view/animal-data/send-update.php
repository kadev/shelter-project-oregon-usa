    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Send Update</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo URL; ?>">Home</a></li>
                        <li class="breadcrumb-item" aria-current="page">Animal Data</li>
                        <li class="breadcrumb-item active" aria-current="page">Send Update</li>
                    </ol>
                </div>
                <div class="d-flex">
                        ...
                        <div class="card-body" style="border: 4px solid lightskyblue;">
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <div>
                                    ...
                                    <p class="text-muted card-sub-title mb-0 mt-2">1. Select the state and shelter you want to update. </p>
                                    <p class="text-muted card-sub-title mb-0">2. Select the year you want to update, edit the fields and click on Send Update. </p>
                                    <p class="text-muted card-sub-title mb-0">3. Wait for your update to be approved.  </p>
                                    <p class="text-muted card-sub-title mb-0">4. View the status of your update in <a href="<?php echo URL; ?>animalData/updates">"Manage Updates"</a>.   </p>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-sm-6">
                                            ...
                                            <select class="form-control states-select" name="state">
                                                ...
                                                <?php foreach ($permissionData as $state): ?>
                            ...
                            <?php else: ?>
                                <div class="alert alert-danger mb-0" role="alert">
                                    ...
                                    <span class="alert-inner--text">
                                        ...
                                        Apparently you do not have permissions assigned yet, please contact the site administrator.
                                    </span>
                                </div>
                            <?php endif; ?>
                        </div>
                                                    ...
                                                    <div class="d-flex">
                                                        <select id="filter-data-by-year" class="form-control year-select" style="color: black;" name="year">
                                                            <?php foreach($years as $y): ?>
                                                                <option value="<?php echo $y; ?>" <?php echo (isset($year) AND $year == $y) ? 'selected':''; ?>><?php echo $y; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <form id="form-animal-data">
                                                ...
                                                <?php foreach ($animals as $animal): ?>
                                                    <?php if(isset($shelter) AND isset($year)):
                                                        $animal_data = $this->_animaldata->getByAnimalShelterIDAndYear($animal->id, $shelter->id, $year);
                                                    else:
                                                        $animal_data = NULL;
                                                    endif;
                                                    ?>
                                                ...
                                                <tr>
                                                    <td colspan="11">
                                                        ...
                                                        <span id="send-update" class="btn ripple btn-success d-none"><i class="fe fe-edit"></i> Send update</span>
                                                        <span id="save-data" class="btn ripple btn-success d-none"><i class="fe fe-edit"></i> Send update</span>
                                                    </td>
                                                </tr>
                                                </tfoot>
                                            </form>
