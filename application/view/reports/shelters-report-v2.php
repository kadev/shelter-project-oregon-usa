    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div id="reports-section" class="row row-sm">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12  col-xl-12 col-xxl-6 d-none">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-6">
                    <div class="card custom-card overflow-hidden " id="received-animal-data-container">
                        <div class="card-header border-bottom-0 d-flex">
                            <div>
                                <label class="main-content-label mb-2">Received Data from the last 10 years</label>
                            </div>
                        </div>
                        <div class="card-body pl-0">
                            <div class>
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-6">
                    <div class="card custom-card overflow-hidden " id="returned-animal-data-container">
                        <div class="card-header border-bottom-0 d-flex">
                            <div>
                                <label class="main-content-label mb-2">Returned Data from the last 10 years</label>
                            </div>
                        </div>
                        <div class="card-body pl-0">
                            <div class>
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-6">
                    <div class="card custom-card overflow-hidden " id="placed-animal-data-container">
                        <div class="card-header border-bottom-0 d-flex">
                            <div>
                                <label class="main-content-label mb-2">Placed Data from the last 10 years</label>
                            </div>
                        </div>
                        <div class="card-body pl-0">
                            <div class>
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-6">
                    <div class="card custom-card overflow-hidden " id="transfered-animal-data-container">
                        <div class="card-header border-bottom-0 d-flex">
                            <div>
                                <label class="main-content-label mb-2">Transfered Data from the last 10 years</label>
                            </div>
                        </div>
                        <div class="card-body pl-0">
                            <div class>
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-6">
                    <div class="card custom-card overflow-hidden " id="euthanized-animal-data-container">
                        <div class="card-header border-bottom-0 d-flex">
                            <div>
                                <label class="main-content-label mb-2">Euthanized Data from the last 10 years</label>
                            </div>
                        </div>
                        <div class="card-body pl-0">
                            <div class>
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-6">
                    <div class="card custom-card overflow-hidden " id="transfered-out-animal-data-container">
                        <div class="card-header border-bottom-0 d-flex">
                            <div>
                                <label class="main-content-label mb-2">Transfered out Data from the last 10 years</label>
                            </div>
                        </div>
                        <div class="card-body pl-0">
                            <div class="">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12  col-xl-12 col-xxl-12">
                    <div id="sr-shelters-table-details" class="card custom-card overflow-hidden">
                        <div class="card-header border-bottom-0 d-flex">
                            <div>
                                <label class="main-content-label my-auto pt-2">Shelter Data Details</label>
                            </div>
                        </div>
