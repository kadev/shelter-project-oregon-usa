    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Edit Report</h2>
                    <ol class="breadcrumb">
                        ...
                        <div class="card-body">
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <div>
                                    ...
                                    <p class="text-muted card-sub-title">Edit the required fields to updte the report.</p>
                                </div>
                                ...
                                <?php if($report != false): ?>
                                    <form id="form-edit-report">
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input name="title" class="form-control" required="" type="text" placeholder="Type here..." value="<?php echo $report->title; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                <div class="col-sm-4">
                                                    ...
                                                    <select name="from" class="form-control from-select">
                                                        ...
                                                        <?php for ($i = 1973; $i <= date("Y"); $i++): ?>
                                                            <option value="<?php echo $i; ?>" <?php echo ($report->from_year == $i) ? 'selected' : ''; ?>>
                                                                <?php echo $i; ?>
                                                            </option>
                                                        <?php endfor;  ?>
                                                    </select>
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <select name="to" class="form-control to-select" placeholder="Choose one">
                                                        <option label="Choose one"></option>
                                                        <?php for ($i = 1973; $i <= date("Y"); $i++): ?>
                                                            <option value="<?php echo $i; ?>" <?php echo ($report->to_year == $i) ? 'selected' : ''; ?>>
                                                                <?php echo $i; ?>
                                                            </option>
                                                        <?php endfor;  ?>
                                                    </select>
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <select name="criteria" class="form-control criteria-select" placeholder="Choose one">
                                                        <option label="Choose one"></option>
                                                        <option value="all" <?php echo ($report->criteria == 'all') ? 'selected' : ''; ?>>All</option>
                                                        <option value="2" <?php echo ($report->criteria == 2) ? 'selected' : ''; ?>>Dogs</option>
                                                        <option value="1" <?php echo ($report->criteria == 1) ? 'selected' : ''; ?>>Cats</option>
                                                        <option label="5" <?php echo ($report->criteria == 5) ? 'selected' : ''; ?>>Rabbits</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea class="form-control" id="description" name="description" rows="3"><?php echo $report->description; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row row-sm">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input name="published" class="form-control" type="hidden" value="<?php echo $report->published ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-row-reverse mt-5">
                                            <div id="edit-report" class="btn ripple btn-main-primary btn-lg" data-report="<?php echo $report->id; ?>">
