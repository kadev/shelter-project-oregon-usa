    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Create County</h2>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create County</li>
                    </ol>
                </div>
            </div>
            <!-- End Page Header -->
                        ...
                        <div class="card-body">
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <div>
                                    ...
                                    <p class="text-muted card-sub-title">Enter the required fields to create the new county.</p>
                                </div>
                                <form id="form-create-county">
                                    ...
                                    <div class="d-flex flex-row justify-content-end">
                                        <span id="create-county" class="btn ripple btn-main-primary btn-lg">Create</span>
                                    </div>
                                </form>
                            </div>
                        </div>
