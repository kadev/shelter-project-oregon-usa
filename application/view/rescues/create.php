    ...
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Create Rescue</h2>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Rescue</li>
                    </ol>
                </div>
            </div>
            <!-- End Page Header -->
                            ...
                            <div class="card-body">
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                    <div>
                                        ...
                                        <p class="text-muted card-sub-title">Enter the required fields to create the new rescue.</p>
                                    </div>
                                    <div class="form-group">
                                        <div class="row row-sm">
                                            <div class="col-sm-6 c-upl-image shelter-logo-container" data-input="shelter-logo">
                                                <label class="">Rescue logo: </label>
                                            ...
                                            <div class="col-sm-6 c-upl-image shelter-image-container" data-input="shelter-image">
                                                <label class="">Rescue Image: </label>
                                    ...
                                    <div class="form-group">
                                        <div class="row row-sm">
                                            <div class="col-sm-6">
                                                <label class="">Rescue Name: <span class="tx-danger">*</span></label>
                            ...
                            <div class="card-body">
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-sm-4 d-none">
                                                ...
                                                <select id="" name="type-of-entry" class="form-control">
                                                    ...
                                                    <option value="3" selected>Rescue</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        <span id="create-shelter" data-origin="rescues" class="btn ripple btn-main-primary btn-lg mb-3 mt-5">Create</span>
                                    </div>
                                </div>
                            </div>
                        </div>
